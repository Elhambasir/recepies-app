...
RSpec.describe Recipe, type: :model do
  ...
  it 'preparation time should be an decimal' do
    expect(subject.preparation_time.to_f).to be_a(Float)
  end
  ...
  it 'cooking time should be an decimal' do
    expect(subject.cooking_time.to_f).to be_a(Float)
  end
